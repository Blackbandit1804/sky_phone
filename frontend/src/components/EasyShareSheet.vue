...
.easyshare-host :deep(.k-sheet){z-index:9500;width:100%;max-width:none}.easyshare-host--opened :deep(.k-sheet){translate:0 calc(-100% + var(--easyshare-drag-offset,0px))}.easyshare-host--dragging :deep(.k-sheet){transition-duration:0ms}.easyshare-panel{max-height:645px;background:rgb(28 28 30 / 92%)}.phone-app--light .easyshare-panel{background:rgb(242 242 247 / 93%)}.easyshare-detail{max-height:463px}.easyshare-targets button>div,.easyshare-history article>div{min-width:0}.easyshare-targets strong,.easyshare-targets small,.easyshare-history strong,.easyshare-history small{overflow-wrap:anywhere}
