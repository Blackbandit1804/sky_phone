    ...
    Nui = {
        ...
        Apps = {
            ...
            feather = {
                ...
                replies = "Replies", noReplies = "No replies yet. Start the conversation.", likes = "Likes", bookmarks = "Bookmarks", delete = "Delete", report = "Report", block = "Block @{handle}",
                ...
                errors = { accountRequired = "Sign in to iFruit in Settings first.", invalidHandle = "Use 3–30 letters, numbers or underscores.", handleTaken = "That handle is already taken.", invalidPost = "Write something or attach a photo.", generic = "Something went wrong. Please try again." },
            ...
            skyride = {
             ...
             house = {
                name = "House", subtitle = "Homes and access", myHomes = "My Homes",
                properties = "Properties", owned = "Owned", shared = "Shared with you",
                locked = "Locked", unlocked = "Unlocked", owner = "Owner", keyholder = "Key holder",
                ...
                unavailable = "Homes unavailable", empty = "No Homes", emptyBody = "Owned homes and homes shared with you will appear here.",
                provider = "Housing data · {system}", access = "Access", status = "Status",
                actions = "Controls", setWaypoint = "Directions", viewCamera = "View Camera",
